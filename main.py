# -*- coding: utf-8 -*-
"""
Created on Thu Nov  9 10:45:22 2017
...
i3Dview=1
if(i3Dview==0):
	print(1,'3D view INACTIVE! \n')
#%
print(1,'Fluid model = %c  \n',fluid_model)
print(1,'Fluid formulation (0=Eulerian, 1=Lagrangian, 2=ALE) = %g  \n',formulation)
...
while Total_time<( Tmax - Delta_t):
    ...
    Delta_t_storage[istep-1] = Delta_t
    Total_time             = Total_time + Delta_t
    t[istep-1]               = Total_time
    #%
    #%%%%%%%%%%%% STRUCTURE %%%%%%%%%%%%
    structure
    #%
